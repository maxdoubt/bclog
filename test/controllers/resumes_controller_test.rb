...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { cover: @resume.cover, name: @resume.name, title: @resume.title, visits: @resume.visits }
    end
  ...
  test "should update resume" do
    patch :update, id: @resume, resume: { cover: @resume.cover, name: @resume.name, title: @resume.title, visits: @resume.visits }
    assert_redirected_to resume_path(assigns(:resume))
  end
